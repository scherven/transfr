...
def _leg(d: Dict[str, Any], departure_platform_actual: Optional[str] = None,
    ...
    return schemas.Leg(
        ...
        planned_departure_platform=d.get("planned_departure_platform"),
        planned_arrival_platform=d.get("planned_arrival_platform"),
...
def _transfer(a: TransferAssessment, fallback_station: Optional[str],
    ...
    return schemas.Transfer(
        ...
        planned_arrival_platform=a.planned_arrival_platform,
        planned_departure_platform=a.planned_departure_platform,
...
def _pending_transfer(arrive: Dict[str, Any], depart: Dict[str, Any]) -> schemas.Transfer:
    ...
    return schemas.Transfer(
        ...
        planned_arrival_platform=map_track_to_ref(arrive.get("planned_arrival_platform")),
        planned_departure_platform=map_track_to_ref(depart.get("planned_departure_platform")),
...
def assess_interchanges(conn, interchanges_in: List["schemas.AssessInterchange"], *,
    ...
    for ic in interchanges_in:
        a = assess_transfer(
            ...
            planned_arr_platform=ic.planned_arr_platform,
            planned_dep_platform=ic.planned_dep_platform,
            buffer_s=buffer_s, algorithm=algorithm, avoid_elevators=avoid_elevators,
            resolve_cache=resolve_cache,
        )
